    ...
    <div class="project-card-container">
        <div class="project-content">
            ...
            <div class="project-footer">                
                ...
                <v-divider style="height: 1px; width: 100%; background-color: gray; margin: 0.5rem 0 0.7rem 0;"></v-divider>
        ...
        >
            ...
            <div style="height: 350px; width: 100%; padding: 16px" v-if="isExpanded">
                <v-carousel 
                    height="100%"
                    :show-arrows="false"
                >
